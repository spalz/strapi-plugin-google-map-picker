...
const MapPickerComponent = (props) => {
    ...
    return config && config.apiKey && config.default_center ? (react_1.default.createElement(MapPickerInput_1.default, Object.assign({}, props, { config: config }))) : (!isLoading && !config.apiKey) || (!isLoading && !config.default_center) ? (react_1.default.createElement(react_1.default.Fragment, null,
